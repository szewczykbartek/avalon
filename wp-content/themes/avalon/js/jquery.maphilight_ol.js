(function($) {
    ...
    if (has_canvas) {
        ...
        add_shape_to = function(canvas, shape, coords, options, name, status) {
            ...
            if (options.fill) {
                ...
                console.log('status: '+status);
                if (status == 'sold') {
                    context.fillStyle = css3color('000000', 1);
        ...
        return this.each(function() {
            ...
            $(map).bind('alwaysOn.maphilight', function() {
                ...
                $(map).find('area[coords]').each(function() {
                    ...
                    if (area_options.alwaysOn || $(this).data('status') == 'sold') {
                        ...
                        if (has_canvas) {
                            add_shape_to(canvas_always, shape[0], shape[1], area_options, "", 'sold');
                        } else {
                            add_shape_to(canvas, shape[0], shape[1], area_options, "", 'sold');
                        }
                    }
                });
